...
function openDetails() {
  var details = document.querySelector('.menu_link-details'),
  ...
  details.addEventListener('click', function (e) {
    ...
    if (detailsCart.style.display == 'none') {
      showCart();
      detailsCloseCart.addEventListener('click', function () {
        hideCart();
      });
    } else {
      hideCart();
...
function sliderRange(selectorRange, spanValue) {
  var inputRange = document.querySelector(selectorRange),
      spanValueRange = document.getElementById(spanValue);

  inputRange.oninput = function () {
    spanValueRange.innerText = this.value + '%';
    var inputRange1 = document.querySelector('.customRange1'),
        ...
        inputRange4Span = document.getElementById('constructor_range-value4'); // inputRange2.value = 100 - +inputRange1.value
...
function creatNewElInDetails() {
  var addToDetails = document.querySelector('.about_btn');
  addToDetails.addEventListener('click', function (event) {
    event.preventDefault();
    var inputRange1Span = document.getElementById('constructor_range-value1'),
        inputRange2Span = document.getElementById('constructor_range-value2'),
        inputRange3Span = document.getElementById('constructor_range-value3'),
    ...
    var cartList = document.querySelector('.details_progress-bar');
    newCart.innerHTML = "\n         <div\n            class=\"col-md-1 details_progress-item-img\"\n         >\n            <img\n               src=\"assets/img/header/header-details/semen-black.png\"\n               alt=\"semen-black\"\n            />\n         </div>\n         <div class=\"col-md-9 item_progress\">\n            <ul class=\"col-lg-5 col-md-6 col-sm-11\n            progress_percent\">\n               <li class=\"progress_precent-item\">".concat(inputRange1Span.innerText, "</li>\n               <li class=\"progress_precent-item\">\n               ").concat(inputRange2Span.innerText, "\n               </li>\n               <li class=\"progress_precent-item\">\n               ").concat(inputRange3Span.innerText, "\n               </li>\n               <li class=\"progress_precent-item\">\n               ").concat(inputRange4Span.innerText, "\n               </li>\n            </ul>\n            <div class=\"progress\">\n               <div\n                  class=\"progress-bar\"\n                  role=\"progressbar\"\n                  style=\"width: ").concat(inputRange1Span.innerText, "\"\n                  aria-valuenow=\"15\"\n                  aria-valuemin=\"0\"\n                  aria-valuemax=\"100\"\n               ></div>\n               <div\n                  class=\"progress-bar bg-success\"\n                  role=\"progressbar\"\n                  style=\"width: ").concat(inputRange2Span.innerText, "\"\n                  aria-valuenow=\"30\"\n                  aria-valuemin=\"0\"\n                  aria-valuemax=\"100\"\n               ></div>\n               <div\n                  class=\"progress-bar bg-info\"\n                  role=\"progressbar\"\n                  style=\"width: ").concat(inputRange3Span.innerText, "\"\n                  aria-valuenow=\"20\"\n                  aria-valuemin=\"0\"\n                  aria-valuemax=\"100\"\n               ></div>\n               <div\n                  class=\"progress-bar bg-dark\"\n                  role=\"progressbar\"\n                  style=\"width: ").concat(inputRange4Span.innerText, "\"\n                  aria-valuenow=\"20\"\n                  aria-valuemin=\"0\"\n                  aria-valuemax=\"100\"\n               ></div>\n            </div>\n         </div>\n         <div class=\"col-md-1 details_delete\">\n            <button class=\"btn-delete\">\n               <i class=\"fas fa-times\"></i>\n            </button>\n         </div>\n      ");
